...
Version  : 43.1
Release  : 132
URL      : https://download.gnome.org/sources/mutter/43/mutter-43.1.tar.xz
Source0  : https://download.gnome.org/sources/mutter/43/mutter-43.1.tar.xz
...
%prep
%setup -q -n mutter-43.1
cd %{_builddir}/mutter-43.1
pushd ..
cp -a mutter-43.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667864155
