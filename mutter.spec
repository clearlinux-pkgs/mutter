...
Source0  : https://download.gnome.org/sources/mutter/45/mutter-45.3.tar.xz
...
%prep
%setup -q -n mutter-45.3
cd %{_builddir}/mutter-45.3
%patch -P 1 -p1
pushd ..
cp -a mutter-45.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704733265
