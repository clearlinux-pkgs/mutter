...
Source0  : https://download.gnome.org/sources/mutter/46/mutter-46.3.tar.xz
...
%prep
%setup -q -n mutter-46.3
cd %{_builddir}/mutter-46.3
%patch -P 1 -p1
pushd ..
cp -a mutter-46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719935532
