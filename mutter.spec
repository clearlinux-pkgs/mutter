...
Version  : 3.38.1
Release  : 79
URL      : https://download.gnome.org/sources/mutter/3.38/mutter-3.38.1.tar.xz
Source0  : https://download.gnome.org/sources/mutter/3.38/mutter-3.38.1.tar.xz
...
%prep
%setup -q -n mutter-3.38.1
cd %{_builddir}/mutter-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601935668
...
cp %{_builddir}/mutter-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/mutter/4cc77b90af91e615a64ae04893fdffa7939db84c
