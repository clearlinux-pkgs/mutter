...
Version  : 45.4
Release  : 161
URL      : https://download.gnome.org/sources/mutter/45/mutter-45.4.tar.xz
Source0  : https://download.gnome.org/sources/mutter/45/mutter-45.4.tar.xz
...
%prep
%setup -q -n mutter-45.4
cd %{_builddir}/mutter-45.4
%patch -P 1 -p1
pushd ..
cp -a mutter-45.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707765857
