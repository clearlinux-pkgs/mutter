...
%prep
%setup -q -n mutter-3.38.0
cd %{_builddir}/mutter-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600273945
...
cp %{_builddir}/mutter-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/mutter/4cc77b90af91e615a64ae04893fdffa7939db84c
