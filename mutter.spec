...
Version  : 45.1
Release  : 158
URL      : https://download.gnome.org/sources/mutter/45/mutter-45.1.tar.xz
Source0  : https://download.gnome.org/sources/mutter/45/mutter-45.1.tar.xz
...
%prep
%setup -q -n mutter-45.1
cd %{_builddir}/mutter-45.1
%patch -P 1 -p1
pushd ..
cp -a mutter-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698849688
