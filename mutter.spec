...
Version  : 46.0
Release  : 164
URL      : https://download.gnome.org/sources/mutter/46/mutter-46.0.tar.xz
Source0  : https://download.gnome.org/sources/mutter/46/mutter-46.0.tar.xz
...
Patch2: backport-drm-buffer-gbm-Do-not-call-ensure_fb_id-from-lock_fr.patch
Patch3: backport-compositor-sync-ring-Allow-the-gpu_fence-to-be-moved.patch
...
%prep
%setup -q -n mutter-46.0
cd %{_builddir}/mutter-46.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mutter-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713377944
